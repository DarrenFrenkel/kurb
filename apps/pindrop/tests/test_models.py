...
class Add_GeocoordinatesTestCast(TestCase):
    def test_returning_latitude_and_longditude(self):
        ...
        addressBook = [address('2 Dunbar Ave','VIC', 3161, -37.878505, 145.019607),
                       address('19 Dunbar Ave','Victoria', 3161, -37.878945, 145.021097),
                       address('15 Stkilda Rd', 'Victoria', 3004, -37.818164, 144.967869),
                       address('151 3rd St', 'California', 94103, 37.785716, -122.401064) ]
